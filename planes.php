...
<head>
    ...
    <title>🏋️ Planes y Precios | Entrenamiento Deportivo</title>
        ...
        (function(){
          ...
          confirmBtn?.addEventListener('click', async ()=>{
            ...
            try {
              ...
              showPlanToast(data?.success ? `Elegiste el plan ${currentPlan.name}.` : (data?.message || 'No se pudo guardar tu elección'));
            } catch (e) {
