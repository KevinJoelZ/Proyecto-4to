...
<footer class="main-footer">
    <div class="footer-content">
        ...
        <div class="footer-section">
            <h4>Servicios</h4>
            <ul>
                <li><a href="servicios.php">Entrenamiento Personal</a></li>
                <li><a href="servicios.php">Cursos Certificados</a></li>
                <li><a href="planes.php">Planes de Nutrición</a></li>
                <li><a href="servicios.php">Asesoría Deportiva</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4>Deportes</h4>
            <ul>
                <li><a href="servicios.php">Running</a></li>
                <li><a href="servicios.php">Fitness</a></li>
                <li><a href="servicios.php">Natación</a></li>
                <li><a href="servicios.php">Ciclismo</a></li>
            </ul>
        </div>
        <div class="footer-section">
            <h4>Contacto</h4>
    ...
    <div class="footer-bottom">
        &copy; <?php echo $anio; ?> DeporteFit. Todos los derechos reservados.
    </div>
</footer>
