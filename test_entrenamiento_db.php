 ...
 * se conecta correctamente a la base de datos plataforma_fitness
 * y guarda en la tabla entrenamientos_realizados
 */

header('Content-Type: text/html; charset=utf-8');

echo "<h1>Test de Conexión - Formulario de Entrenamiento</h1>";
...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>Por favor, ejecuta el script <a href='verificar_tabla_entrenamientos.php'>verificar_tabla_entrenamientos.php</a> para crear la tabla.</p>";
    }
    
    echo "<h2 style='color: green;'>✓ Test de conexión completado</h2>";
    echo "<p>El formulario de entrenamiento está conectado correctamente a la base de datos plataforma_fitness.</p>";
